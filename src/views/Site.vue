        ...
        <nav class="navbar navbar-light bg-light menu-superior">
            <div class="container">
                ...
                <ul class="navbar-nav links">
                    ...
                    <li class="nav-item" > 
                        <router-link class="nav-link" to="#secao_2">Seção 2</router-link>
                    </li>
                    <li class="nav-item" > 
                        <router-link class="nav-link" to="#secao_3">Seção 3</router-link>
                    </li>
                    <li class="nav-item">
